...
final class CanonicalCode {
	 ...
	 * lengths.
	 * Each code length must be non-negative. Code length 0 means no code for the
	 * symbol.
	 * The collection of code lengths must represent a proper full Huffman code
	 * tree.
	 * <p>
	 ...
	 *                                  exceeds MAX_CODE_LENGTH,
	 *                                  or the collection of code lengths would
	 *                                  yield an under-full or over-full Huffman
	 *                                  code tree
	 */
