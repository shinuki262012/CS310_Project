...
public final class Decompressor {
	...
	public static void main(String[] args) {
		try {
			...
			// test("01110011 00001101 01110011 01110100 00000101 00100011 00000000",
			// "abaa");
			test("11001110 10110000 11001110 00101110 10100000 11000100 00000000", "abaa");
		} catch (Exception e) {
			e.printStackTrace();
